...
import 'page_membros_detalhes_pastor_model.dart';
export 'page_membros_detalhes_pastor_model.dart';

class PageMembrosDetalhesPastorWidget extends StatefulWidget {
  const PageMembrosDetalhesPastorWidget({
    super.key,
  ...
  static String routeName = 'PageMembros_Detalhes_Pastor';
  static String routePath = '/pageMembrosDetalhesPastor';

  @override
  State<PageMembrosDetalhesPastorWidget> createState() =>
      _PageMembrosDetalhesPastorWidgetState();
}

class _PageMembrosDetalhesPastorWidgetState
    extends State<PageMembrosDetalhesPastorWidget> {
  late PageMembrosDetalhesPastorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageMembrosDetalhesPastorModel());
    _carregarDados();
  }
