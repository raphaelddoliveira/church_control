...
import 'page_ministerio_detalhes_secretaria_model.dart';
export 'page_ministerio_detalhes_secretaria_model.dart';

class PageMinisterioDetalhesSecretariaWidget extends StatefulWidget {
  const PageMinisterioDetalhesSecretariaWidget({
    super.key,
  ...
  static String routeName = 'PageMinisterio_Detalhes_Secretaria';
  static String routePath = '/pageMinisterioDetalhesSecretaria';

  @override
  State<PageMinisterioDetalhesSecretariaWidget> createState() =>
      _PageMinisterioDetalhesSecretariaWidgetState();
}

class _PageMinisterioDetalhesSecretariaWidgetState
    extends State<PageMinisterioDetalhesSecretariaWidget> {
  late PageMinisterioDetalhesSecretariaModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => PageMinisterioDetalhesSecretariaModel());
                                      ...
                                      Row(
                                        children: [
                                          InkWell(
                                            onTap: () {
                                              context.pushNamed(
                                                PageMinisteriosSecretariaWidget.routeName,
                                              );
                                            },
                                            borderRadius: BorderRadius.circular(12),
                                            child: Container(
