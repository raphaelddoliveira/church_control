                                              ...
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  ...
                                                  _model.apiResult02d =
                                                    ...
                                                    senha:
                                                        _model.senhaaleatoria,
                                                  );

                                                  if ((_model.apiResult02d
                                                          ?.succeeded ??
                                                      true)) {
                                                    await MembrosTable().update(
                                                      data: {
                                                        'id_auth': getJsonField(
                                                          (_model.apiResult02d
                                                                  ?.jsonBody ??
                                                              ''),
                                                          r'''$.user.id''',
                                                  ...
                                                  await showDialog(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        title: Text('Sucesso!'),
                                                        content: Text(
                                                            'Notificação enviada para o membro!'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
