...
import 'dart:ui';
import '/index.dart';
import 'page_membros_editar_detalhes_secretaria_widget.dart'
    show PageMembrosEditarDetalhesSecretariaWidget;
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class PageMembrosEditarDetalhesSecretariaModel
    extends FlutterFlowModel<PageMembrosEditarDetalhesSecretariaWidget> {
  ///  State fields for stateful widgets in this page.

  // Model for Menu_Secretaria component.
  late MenuSecretariaModel menuSecretariaModel;
  // Stores action output result for [Backend Call - Update Row(s)] action in Button widget.
  List<EnderecoRow>? retornorow;
  // Stores action output result for [Backend Call - Query Rows] action in Button widget.
  List<EnderecoRow>? listretorno;
  // Stores action output result for [Backend Call - Update Row(s)] action in Button widget.
  List<MembrosRow>? linhamembro;
  // Stores action output result for [Backend Call - Query Rows] action in Button widget.
