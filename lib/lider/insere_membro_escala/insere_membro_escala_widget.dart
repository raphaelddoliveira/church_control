...
import 'insere_membro_escala_model.dart';
export 'insere_membro_escala_model.dart';

class InsereMembroEscalaWidget extends StatefulWidget {
  const InsereMembroEscalaWidget({
    super.key,
  ...
  @override
  State<InsereMembroEscalaWidget> createState() =>
      _InsereMembroEscalaWidgetState();
}

class _InsereMembroEscalaWidgetState extends State<InsereMembroEscalaWidget> {
  late InsereMembroEscalaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InsereMembroEscalaModel());
                            ...
                            FutureBuilder<List<MembrosRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final containerMembrosRow =
                                    containerMembrosRowList.isNotEmpty
                                        ? containerMembrosRowList.first
                                        : null;
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            valueOrDefault<String>(
                                              containerMembrosRow?.nomeMembro,
                                              'Nome',
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                              ...
                              return FFButtonWidget(
                                onPressed: () async {
                                  await MembrosEscalasTable().insert({
                                    ...
                                    'funcao_escala': _model.textController.text,
                                  });
                                  await EnvioDadosEscalaCall.call(
                                    funcao: _model.textController.text,
