                          ...
                          child: Column(
                            ...
                            children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FutureBuilder<
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<ResumoFinanceiroRow>
                                                containerResumoFinanceiroRowList =
                                                snapshot.data!;

                                            final containerResumoFinanceiroRow =
                                                containerResumoFinanceiroRowList
                                                        .isNotEmpty
                                                    ? containerResumoFinanceiroRowList
                                                        .first
                                                      ...
                                                      style:
                                                          FlutterFlowTheme.of(
                                                              ...
                                                              .override(
                                                                ...
                                                                color: containerResumoFinanceiroRow!
                                                                            .saldoTotal! >
                                                                        0.0
                                                                    ? Color(
                                                                        0xFF249689)
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            FutureBuilder<
                                                List<VwSaidasMesAtualRow>>(
                                              future: VwSaidasMesAtualTable()
                                                  .queryRows(
                                                queryFn: (q) => q,
                                              ),
                                              builder: (context, snapshot) {
                                                ...
                                                List<VwSaidasMesAtualRow>
                                                    listViewVwSaidasMesAtualRowList =
                                                    snapshot.data!;
                                                ...
                                                return ListView.builder(
                                                  ...
                                                  itemBuilder:
                                                    ...
                                                    final listViewVwSaidasMesAtualRow =
                                                        listViewVwSaidasMesAtualRowList[
                                                            listViewIndex];
                                                    return Padding(
                                                      padding:
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return Dialog(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            InfoContaPastorWidget(
                                                                          idsaida:
                                                                              listViewVwSaidasMesAtualRow.idSaida!,
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
                                      ...
                                      FutureBuilder<
                                          List<QuantidadeEntradasRow>>(
                                        future:
                                            QuantidadeEntradasTable().queryRows(
                                          queryFn: (q) => q,
                                        ),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          ...
                                          List<QuantidadeEntradasRow>
                                              containerQuantidadeEntradasRowList =
                                              snapshot.data!;
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 8.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Gráfico de Entradas Financeiras',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .headlineSmall
                                                        .override(
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    24.0, 0.0, 24.0, 16.0),
                                child: FutureBuilder<List<MembrosPorMesRow>>(
                                  future: MembrosPorMesTable().queryRows(
                                    queryFn: (q) => q,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
