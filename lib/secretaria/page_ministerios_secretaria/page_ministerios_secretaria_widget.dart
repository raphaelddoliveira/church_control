...
import 'page_ministerios_secretaria_model.dart';
export 'page_ministerios_secretaria_model.dart';

class PageMinisteriosSecretariaWidget extends StatefulWidget {
  const PageMinisteriosSecretariaWidget({super.key});

  static String routeName = 'PageMinisterios_Secretaria';
  static String routePath = '/pageMinisteriosSecretaria';

  @override
  State<PageMinisteriosSecretariaWidget> createState() =>
      _PageMinisteriosSecretariaWidgetState();
}

class _PageMinisteriosSecretariaWidgetState
    extends State<PageMinisteriosSecretariaWidget> {
  late PageMinisteriosSecretariaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageMinisteriosSecretariaModel());
